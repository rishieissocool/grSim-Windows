...
#include <memory>
#include "../../../../vartypes-src/vartypes/primitives/VarQWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarQWidget_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject VarTypes::VarQWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<VarType::staticMetaObject>(),
    qt_meta_stringdata_VarTypes__VarQWidget.data,
    qt_meta_data_VarTypes__VarQWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VarTypes::VarQWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarQWidget.stringdata0))
