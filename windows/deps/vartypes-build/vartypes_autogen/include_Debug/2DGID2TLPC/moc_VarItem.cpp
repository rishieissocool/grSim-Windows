...
#include <memory>
#include "../../../../vartypes-src/vartypes/gui/VarItem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarItem_t, stringdata0) + ofs \
...
void VarTypes::VarItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VarItem *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject VarTypes::VarItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_VarTypes__VarItem.data,
    qt_meta_data_VarTypes__VarItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VarTypes::VarItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarItem.stringdata0))
