...
#include <memory>
#include "../../../../vartypes-src/vartypes/primitives/VarStringEnum.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarStringEnum_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject VarTypes::VarStringEnum::staticMetaObject = { {
    QMetaObject::SuperData::link<VarType::staticMetaObject>(),
    qt_meta_stringdata_VarTypes__VarStringEnum.data,
    qt_meta_data_VarTypes__VarStringEnum,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VarTypes::VarStringEnum::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarStringEnum.stringdata0))
