...
#include <memory>
#include "../../../../vartypes-src/vartypes/primitives/VarList.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarList_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 37, 5), // "child"
QT_MOC_LITERAL(5, 43, 12) // "childRemoved"

    },
    "VarTypes::VarList\0childAdded\0\0VarPtr\0"
    "child\0childRemoved"
};
...
void VarTypes::VarList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VarList *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (VarList::*)(VarPtr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VarList::childAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (VarList::*)(VarPtr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VarList::childRemoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VarTypes::VarList::staticMetaObject = { {
    QMetaObject::SuperData::link<VarType::staticMetaObject>(),
    qt_meta_stringdata_VarTypes__VarList.data,
    qt_meta_data_VarTypes__VarList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VarTypes::VarList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarList.stringdata0))
